  ...
  return (
    <BackgroundLines>
      <div className="absolute inset-0 z-0">
        <div
          className="min-h-screen w-full flex h-screen max-h-full flex-col  bg-gradient-to-tr from-black via-red-700 to-black
        ...
        >
          ...
          <div className="mt-13 ">
            <div className="max-w-6xl mx-auto grid grid-cols-1   md:grid-cols-3 gap-8 text-center  ">
              <div className="shadow-xl p-4 py-8 md:py-18 rounded-2xl mt-3">
              ...
              <div className="shadow-xl p-4 py-8 mt-3 md:py-18 rounded-2xl">
